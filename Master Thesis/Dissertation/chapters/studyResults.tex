...
Figures \ref{fig:white_1}, \ref{fig:white_2} and \ref{fig:white_3} all represent the set of answer-pairs with one white component, for questions one, ten and fifteen, respectively. \par
%
\begin{figure}[!htbp]
  \centering
...
significant correlations ($\rho < 0.05$) when comparing the distances from answers blended in each color model (HSV, CIE-L*C*h*, CMYK, RGB and CIE-L*a*b*) with the age from the users, except for a small subset of questions: from all 32 questions asked, seven of them presented weak,
...
%
Particularizar para casos de perguntas que tenham valores interessantes. \\
Concluir \\
%
\subsubsection{Gender Groups}
\label{subsubsec:demo_age}
%
Recalling Table \ref{table:profiling_genderacademic}, present of Section \ref{subsec:results_userprofile}, we have collected a total of 259 users, being \ul{105 Female Users}, \ul{152 Male Users} and \ul{2 Other Gender Users}. From these users,
%
Referir perguntas (são 8). \\
Particulizar para casos interessantes, se houver. \\
Concluir \\
%
\subsubsection{Color Vision Deficient Users Group}
\label{subsubsec:demo_daltonic}
%
Analise breve e de alto nivel. \\
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                DISCUSSION                                                                       %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
