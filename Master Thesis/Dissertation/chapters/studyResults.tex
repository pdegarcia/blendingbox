...
\begin{table}[htbp]
  \resizebox{\textwidth}{!} {
  \begin{tabular}{@{}ccc|c|ccccc|ccccc@{}}
    \toprule
    ...
    C1      & C2                           & \multicolumn{2}{c|}{C3}                                                                          & \#1           & \#2           & \#3          & \#4        & \#5        & \#1                                      & \#2                                      & \#3                                & \#4                                      & \multicolumn{1}{c|}{\#5}           \\ \midrule
    Red     & \multicolumn{1}{c|}{Green}   & \multicolumn{2}{c|}{\cellcolor[HTML]{FFFF00}(77, 93, 14)}                                        & \textbf{CMYK} & CIE-L*a*b*    & RGB          & HSV        & CIE-L*C*h* & \textbf{CMYK}                            & \textbf{CIE-L*a*b*}                      & HSV                                & RGB                                      & \multicolumn{1}{c|}{CIE-L*C*h*}    \\ \midrule
    Red     & \multicolumn{1}{c|}{Blue}    & \multicolumn{2}{c|}{\cellcolor[HTML]{FF00FF}(59, 28, 97)}                                        & \textbf{CMYK} & CIE-L*a*b*    & CIE-L*C*h*   & RGB        & HSV        & HSV                                      & RGB                                      & \textbf{CMYK}                      & \textbf{CIE-L*a*b*}                      & \multicolumn{1}{c|}{CIE-L*C*h*}    \\ \midrule
    Green   & \multicolumn{1}{c|}{Blue}    & \multicolumn{2}{c|}{\cellcolor[HTML]{00FFFF}}                                                    & \multicolumn{5}{c|}{-}                                                 & \textbf{CIE-L*a*b*}                      & \multicolumn{2}{c}{HSV, RGB}                                                  & CMYK                                     & \multicolumn{1}{c|}{CIE-L*C*h*}    \\ \midrule
    Red     & \multicolumn{1}{c|}{Cyan}    & \cellcolor[HTML]{80FF00}(45, 76, 12) & \cellcolor[HTML]{7F00FF}(27, 12, 95)                      & \textbf{CMYK} & HSV           & RGB          & CIE-L*a*b* & CIE-L*C*h* & RGB                                      & \textbf{CMYK}                            & \textbf{CIE-L*a*b*}                & HSV                                      & \multicolumn{1}{c|}{CIE-L*C*h*}    \\ \midrule
    Red     & \multicolumn{1}{c|}{Magenta} & \multicolumn{2}{c|}{\cellcolor[HTML]{FF0080}(45, 23, 22)}                                        & \textbf{CMYK} & CIE-L*a*b*    & RGB          & CIE-L*C*h* & HSV        & HSV                                      & \multicolumn{2}{c}{\textbf{CIE-L*C*h*, CIE-L*a*b*}}                           & RGB                                      & \multicolumn{1}{c|}{\textbf{CMYK}} \\ \midrule
    Red     & \multicolumn{1}{c|}{Yellow}  & \multicolumn{2}{c|}{\cellcolor[HTML]{FF8000}(49, 37, 5)}                                         & CIE-L*a*b*    & \textbf{CMYK} & HSV          & RGB        & CIE-L*C*h* & \multicolumn{3}{c|}{\textbf{CMYK, CIE-L*C*h*, CIE-L*a*b*}}                                                               & HSV                                      & \multicolumn{1}{c|}{RGB}           \\ \midrule
    Cyan    & \multicolumn{1}{c|}{Magenta} & \multicolumn{2}{c|}{\cellcolor[HTML]{0000FF}(18, 7, 95)}                                         & ?             & ?             & inconclusivo & ?          & ?          & \multicolumn{2}{c|}{\textbf{CMYK, CIE-L*a*b*}}                                      & CIE-L*C*h*                         & RGB                                      & \multicolumn{1}{c|}{HSV}           \\ \midrule
    Magenta & \multicolumn{1}{c|}{Yellow}  & \multicolumn{2}{c|}{\cellcolor[HTML]{FF0000}(41, 21, 2)}                                         & \textbf{CMYK} & CIE-L*C*h*    & HSV          & RGB        & CIE-L*a*b* & \textbf{CIE-L*a*b*}                      & \textbf{CMYK}                            & RGB                                & CIE-L*C*h*                               & \multicolumn{1}{c|}{HSV}           \\ \midrule
    Green   & \multicolumn{1}{c|}{Cyan}    & \multicolumn{2}{c|}{\cellcolor[HTML]{00FF80}(40, 73, 32)}                                        & \textbf{CMYK} & RGB           & CIE-L*a*b*   & HSV        & CIE-L*C*h* & CIE-L*C*h*                               & \textbf{CMYK}                            & \textbf{CIE-L*a*b*}                & HSV                                      & \multicolumn{1}{c|}{RGB}           \\ \midrule
    Green   & \multicolumn{1}{c|}{Magenta} & \cellcolor[HTML]{0080FF}(26, 23, 98) & \cellcolor[HTML]{FF8000}(49, 37, 5)                       & \textbf{CMYK} & RGB           & CIE-L*a*b*   & HSV        & CIE-L*C*h* & RGB                                      & \textbf{CMYK}                            & \textbf{CIE-L*a*b*}                & HSV                                      & \multicolumn{1}{c|}{RGB}           \\ \midrule
    Green   & \multicolumn{1}{c|}{Yellow}  & \multicolumn{2}{c|}{\cellcolor[HTML]{80FF00}(45, 76, 12)}                                        & HSV           & \textbf{CMYK} & RGB          & CIE-L*a*b* & CIE-L*C*h* & \textbf{CMYK}                            & \multicolumn{2}{c}{\textbf{CIE-L*C*h*, CIE-L*a*b*}}                           & RGB                                      & \multicolumn{1}{c|}{HSV}           \\ \midrule
    Blue    & \multicolumn{1}{c|}{Cyan}    & \multicolumn{2}{c|}{\cellcolor[HTML]{0080FF}(26, 23, 98)}                                        & ?             & ?             & inconclusivo & ?          & ?          & \multicolumn{1}{c|}{CIE-L*C*h*}          & \multicolumn{1}{c|}{\textbf{CIE-L*a*b*}} & \multicolumn{1}{c|}{\textbf{CMYK}} & \multicolumn{2}{c|}{HSV, RGB}                                                 \\ \midrule
    Blue    & \multicolumn{1}{c|}{Magenta} & \multicolumn{2}{c|}{\cellcolor[HTML]{8000FF}(27, 12, 95)}                                        & \textbf{CMYK} & HSV           & RGB          & CIE-L*a*b* & CIE-L*C*h* & \multicolumn{2}{c|}{\textbf{CIE-L*C*h*, CIE-L*a*b*}}                                & \multicolumn{1}{c|}{\textbf{CMYK}} & \multicolumn{1}{c|}{RGB}                 & \multicolumn{1}{c|}{HSV}           \\ \midrule
    Blue    & \multicolumn{1}{c|}{Yellow}  & \cellcolor[HTML]{00FF80}(40, 73, 32) & \multicolumn{1}{l|}{\cellcolor[HTML]{FF007F}(45, 23, 22)} & \textbf{CMYK} & RGB           & HSV          & CIE-L*a*b* & CIE-L*C*h* & \multicolumn{1}{c|}{\textbf{CMYK}}       & \multicolumn{1}{c|}{RGB}                 & \multicolumn{1}{c|}{HSV}           & \multicolumn{1}{c|}{\textbf{CIE-L*a*b*}} & \multicolumn{1}{c|}{CIE-L*C*h*}    \\ \midrule
    Cyan    & \multicolumn{1}{c|}{Yellow}  & \multicolumn{2}{c|}{\cellcolor[HTML]{00FF00}(36, 72, 13)}                                        & \textbf{CMYK} & HSV           & RGB          & CIE-L*a*b* & CIE-L*C*h* & \multicolumn{1}{c|}{\textbf{CIE-L*a*b*}} & \multicolumn{1}{c|}{\textbf{CMYK}}       & \multicolumn{1}{c|}{CIE-L*C*h*}    & \multicolumn{1}{c|}{RGB}                 & \multicolumn{1}{c|}{HSV}           \\ \bottomrule
  \end{tabular}}
