...
($\tilde{x}_{HSV-10} = 0.3$, $\sigma_{HSV-10} = 0.15792$) when compared to the standard deviation of the whole model ($\sigma_{HSV} = 0.08$). These results are, thus, consistent with the know fact revealed in the Background of this thesis that
