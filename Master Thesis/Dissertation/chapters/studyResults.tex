...
a XYZ Triple value that maps that color on the CIE Chromaticity Diagram. For every quetsion analyzed below, \textbf{the results are corroborated by the online users},
since a Wilcoxon Test shows that there are no statistically significant differences between the laboratory distances and online ones ($p < 0.05$).
%
\paragraph{\ul{Question 1}}
%
