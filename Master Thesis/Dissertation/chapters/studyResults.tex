...
\begin{table}[htbp]
  \begin{center}
    ...
    \begin{tabular}{
      >{\columncolor[HTML]{FFFFFF}}c ll}
      \hline
      \multicolumn{3}{c}{\cellcolor[HTML]{EFEFEF}Outputs Generated}                                                                                                                                                                                                                                                                                                                                                                             \\ \hline
      \cellcolor[HTML]{FFFFFF}                                                                                  & \multicolumn{1}{l|}{Laboratory Results}          & - Regular and Daltonic Users                                                                                                                                                                                                                                               \\ \cline{2-3}
      \cellcolor[HTML]{FFFFFF}                                                                                  & \multicolumn{1}{l|}{Online Results}              & \begin{tabular}[c]{@{}l@{}}- Regular and Daltonic Users\\ - Uncalibrated Users\end{tabular}                                                                                                                                                                                \\ \cline{2-3}
      \cellcolor[HTML]{FFFFFF}                                                                                  & \multicolumn{1}{l|}{Demographic Results}         & \begin{tabular}[c]{@{}l@{}}- Age below 20 Years\\ - Age between 20 and 29 Years\\ - Age between 30 and 39 Years\\ - Age between 40 and 49 Years\\ - Age between 50 and 59 Years\\ - Age above 60 Years\\ - Female Users\\ - Male Users\\ - Other Gender Users\end{tabular} \\ \cline{2-3}
      \multirow{-4}{*}{\cellcolor[HTML]{FFFFFF}\begin{tabular}[c]{@{}c@{}}Dataset\\ Tables\end{tabular}}        & \multicolumn{1}{l|}{One-Component White Results} & - All responses with one white component                                                                                                                                                                                                                                   \\ \hline
      \cellcolor[HTML]{FFFFFF}                                                                                  & \multicolumn{1}{l|}{Laboratory Results}          & \begin{tabular}[c]{@{}l@{}}- Regular and Daltonic Responses \\ - Responses interpolated in RGB, HSV, CMYK, CIE-L*C*h* and L*a*b*\end{tabular}                                                                                                                              \\ \cline{2-3}
      \cellcolor[HTML]{FFFFFF}                                                                                  & \multicolumn{1}{l|}{Online Results}              & \begin{tabular}[c]{@{}l@{}}- Regular and Daltonic Responses \\ - Uncalibrated Responses\\ - Responses interpolated in RGB, HSV, CMYK, CIE-L*C*h* and L*a*b*\end{tabular}                                                                                                   \\ \cline{2-3}
      \cellcolor[HTML]{FFFFFF}                                                                                  & \multicolumn{1}{l|}{Demographic Results}         & - Responses interpolated in RGB, HSV, CMYK, CIE-L*C*h* and L*a*b*                                                                                                                                                                                                          \\ \cline{2-3}
      \multirow{-4}{*}{\cellcolor[HTML]{FFFFFF}\begin{tabular}[c]{@{}c@{}}Chromaticity\\ Diagrams\end{tabular}} & \multicolumn{1}{l|}{One-Component White Results} & - All responses with one white component                                                                                                                                                                                                                                   \\ \hline
    \end{tabular}}
  \end{center}
...
a XYZ Triple value that maps that color on the CIE-XYZ Chromaticity Diagram.
%
...
results for this question validate the laboratory experience, since a Wilcoxon Test show that there are no statistically significant differences
...
Also, there should be some sort of affinity between RGB and CIE-L*a*b* models, regarding the Laboratory: they both have the same mean distance and deviation values.
...
the opposite output.
These two colors, when blended, produce substantially different colors according to each model interpolation: this question could produce significant different results from model to model,
...
\begin{figure}[htbp]
  ...
  \begin{minipage}{0.48\textwidth}
    ...
    \caption[Online: Answers for Question 10, from regular users.]{Online: Answers for Question 10, from regular users.}
...
\begin{figure}[htbp]
  ...
  \begin{minipage}{0.48\textwidth}
    ...
    \caption[Online: Answers for Question 11, from regular users.]{Online: Answers for Question 11, from regular users.}
    \label{fig:onlineregular_11}
  \end{minipage}\hfill
  \begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{images/results/11_online_HSVresponses.png}
    \caption[Online: Answers for Question 11, from regular users, mixed in HSV Color Model.]{Online: Answers for Question 11, from regular users, mixed in HSV Color Model.}
...
\ref{table:lab_q13_expected}, when this mixture is blended according to each color model it generates similar colors, except for CIE-L*C*h* that has a lighter blending than others. \par
%
...
pairwise the next question to evaluate the effectiveness of this output, for Blue and Yellow colors blending. \textbf{The laboratory results are corroborated by the online ones}, since a Wilcoxon Test show that there
...
\begin{enumerate}
  ...
  %
  \item \ul{Green \& Magenta Blend} - Unlike the previous blend, the results between these questions were quite different between each other concerning the distance to the expected colors: $\overline{x}_{HSV-10} = 0.3$
...
blended according to a CMYK Color Model. However, we have found an interesting behavior from our users when answering these questions: some users indicated the resulting color on both the expected colors (\emph{e.g.}
