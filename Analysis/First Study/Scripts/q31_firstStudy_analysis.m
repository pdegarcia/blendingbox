...
demoResultsAge_50_59     = tableDEM_age20_29(tableDEM_age20_29.id_question == 31,:); demoResultsAge_20_29 = sortrows(demoResultsAge_20_29, 'id'); demoResultsAge_50_59.id_question = []; demoResultsAge_50_59.page_time = []; demoResultsAge_50_59.resets = [];
...
diffs_table = table(distance_expectedC3_limegreen, distance_expectedC3_red, distance_HSV, distance_LCh, distance_CMYK, distance_RGB, distance_Lab);
if size(C3_name, 1) == 1
