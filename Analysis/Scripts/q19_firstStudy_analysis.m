...
path       = '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19';    % -- CHANGE HERE
...
laboratoryResults = tableR_lab(tableR_lab.id_question == 19,:); laboratoryResults = sortrows(laboratoryResults, 'id'); laboratoryResults.id_question = []; laboratoryResults.page_time = []; laboratoryResults.resets = [];
laboratoryResults_dalt = tableDR_lab(tableDR_lab.id_question == 19,:); laboratoryResults_dalt = sortrows(laboratoryResults_dalt, 'id'); laboratoryResults_dalt.id_question = []; laboratoryResults_dalt.page_time = []; laboratoryResults_dalt.resets = [];

% Online Tables     -- CHANGE HERE
onlineResults = tableR_online(tableR_online.id_question == 19,:); onlineResults = sortrows(onlineResults, 'id'); onlineResults.id_question = []; onlineResults.page_time = []; onlineResults.resets = [];
onlineResults_dalt = tableDR_online(tableDR_online.id_question == 19,:); onlineResults_dalt = sortrows(onlineResults_dalt, 'id'); onlineResults_dalt.id_question = []; onlineResults_dalt.page_time = []; onlineResults_dalt.resets = [];
onlineResults_uncal = tableUR_online(tableUR_online.id_question == 19,:); onlineResults_uncal = sortrows(onlineResults_uncal, 'id'); onlineResults_uncal.id_question = []; onlineResults_uncal.page_time = []; onlineResults_uncal.resets = [];

% Demographic Tables -- CHANGE HERE
demoResultsAge_20        = tableDEM_age20(tableDEM_age20.id_question == 19,:); demoResultsAge_20 = sortrows(demoResultsAge_20, 'id'); demoResultsAge_20.id_question = []; demoResultsAge_20.page_time = []; demoResultsAge_20.resets = [];
demoResultsAge_20_29     = tableDEM_age20_29(tableDEM_age20_29.id_question == 19,:); demoResultsAge_20_29 = sortrows(demoResultsAge_20_29, 'id'); demoResultsAge_20_29.id_question = []; demoResultsAge_20_29.page_time = []; demoResultsAge_20_29.resets = [];
demoResultsAge_30_39     = tableDEM_age30_39(tableDEM_age30_39.id_question == 19,:); demoResultsAge_30_39 = sortrows(demoResultsAge_30_39, 'id'); demoResultsAge_30_39.id_question = []; demoResultsAge_30_39.page_time = []; demoResultsAge_30_39.resets = [];
demoResultsAge_40_49     = tableDEM_age40_49(tableDEM_age40_49.id_question == 19,:); demoResultsAge_40_49 = sortrows(demoResultsAge_40_49, 'id'); demoResultsAge_40_49.id_question = []; demoResultsAge_40_49.page_time = []; demoResultsAge_40_49.resets = [];
demoResultsAge_50_59     = tableDEM_age50_59(tableDEM_age50_59.id_question == 19,:); demoResultsAge_50_59 = sortrows(demoResultsAge_50_59, 'id'); demoResultsAge_50_59.id_question = []; demoResultsAge_50_59.page_time = []; demoResultsAge_50_59.resets = [];
demoResultsAge_60        = tableDEM_age60(tableDEM_age60.id_question == 19,:); demoResultsAge_60 = sortrows(demoResultsAge_60, 'id'); demoResultsAge_60.id_question = []; demoResultsAge_60.page_time = []; demoResultsAge_60.resets = [];
demoResultsGender_Female = tableDEM_genF(tableDEM_genF.id_question == 19,:); demoResultsGender_Female = sortrows(demoResultsGender_Female, 'id'); demoResultsGender_Female.id_question = []; demoResultsGender_Female.page_time = []; demoResultsGender_Female.resets = [];
demoResultsGender_Male   = tableDEM_genM(tableDEM_genM.id_question == 19,:); demoResultsGender_Male = sortrows(demoResultsGender_Male, 'id'); demoResultsGender_Male.id_question = []; demoResultsGender_Male.page_time = []; demoResultsGender_Male.resets = [];
demoResultsGender_Other  = tableDEM_genO(tableDEM_genO.id_question == 19,:); demoResultsGender_Other = sortrows(demoResultsGender_Other, 'id'); demoResultsGender_Other.id_question = []; demoResultsGender_Other.page_time = []; demoResultsGender_Other.resets = [];
...
expected_C3    = hsvTable{8,{'H','S','V'}}; expected_C3 = applycform((expected_C3/255), cformRGB_XYZ);             % Position - 'R+B'
...
cieplot();
title('Question 19: Laboratory Regular Users', 'FontSize', 13);              %% -- CHANGE HERE
xlabel('X Value');
ylabel('Y Value');
hold on;
...
text(x_pre_models(3) + 0.02, y_pre_models(3), '\leftarrow CMYK');
scatter(x_pre_models(4), y_pre_models(4), 50, 'diamond', 'black', 'Filled');
text(x_pre_models(4) + 0.02, y_pre_models(4), '\leftarrow RGB');
...
figure('NumberTitle','off');
cieplot();
title('Question 19: Laboratory Daltonic Users', 'FontSize', 13);                 %% -- CHANGE HERE
xlabel('X Value');
ylabel('Y Value');
hold on;
...
figure('NumberTitle','off');
cieplot();
title('Question 19: Online Regular Users', 'FontSize', 13);                 %% -- CHANGE HERE
xlabel('X Value');
ylabel('Y Value');
hold on;
...
scatter(x_pre_models(3), y_pre_models(3), 50, 'diamond', 'black', 'Filled');
text(x_pre_models(3) + 0.02, y_pre_models(3), '\leftarrow CMYK', 'FontSize', 12);
scatter(x_pre_models(4), y_pre_models(4), 50, 'diamond', 'black', 'Filled');
text(x_pre_models(4) + 0.02, y_pre_models(4), '\leftarrow RGB', 'FontSize', 12);
scatter(x_pre_models(5), y_pre_models(5), 50, 'diamond', 'black', 'Filled');
text(x_pre_models(5) + 0.02, y_pre_models(5), '\leftarrow Lab', 'FontSize', 12);
...
figure('NumberTitle','off');
cieplot();
title('Question 19: Online Daltonic Users', 'FontSize', 13);                 %% -- CHANGE HERE
xlabel('X Value');
ylabel('Y Value');
hold on;
...
figure('NumberTitle','off');
cieplot();
title('Question 19: Online Uncalibrated Users', 'FontSize', 13);                 %% -- CHANGE HERE
xlabel('X Value');
ylabel('Y Value');
hold on;
...
figure('NumberTitle','off');
cieplot();
title('Question 19: Users Aged Less Than 20 Years', 'FontSize', 13);              %% -- CHANGE HERE
xlabel('X Value');
ylabel('Y Value');
hold on;
...
figure('NumberTitle','off');
cieplot();
title('Question 19: Users Aged Between 20 and 29 Years', 'FontSize', 13);              %% -- CHANGE HERE
xlabel('X Value');
ylabel('Y Value');
hold on;
...
figure('NumberTitle','off');
cieplot();
title('Question 19: Users Aged Between 30 and 39 Years', 'FontSize', 13);              %% -- CHANGE HERE
xlabel('X Value');
ylabel('Y Value');
hold on;
...
figure('NumberTitle','off');
cieplot();
title('Question 19: Users Aged Between 40 and 49 Years', 'FontSize', 13);              %% -- CHANGE HERE
xlabel('X Value');
ylabel('Y Value');
hold on;
...
figure('NumberTitle','off');
cieplot();
title('Question 19: Users Aged Between 50 and 59 Years', 'FontSize', 13);              %% -- CHANGE HERE
xlabel('X Value');
ylabel('Y Value');
hold on;
...
figure('NumberTitle','off');
cieplot();
title('Question 19: Users Aged Over 60 Years', 'FontSize', 13);              %% -- CHANGE HERE
xlabel('X Value');
ylabel('Y Value');
hold on;
...
figure('NumberTitle','off');
cieplot();
title('Question 19: Female Users', 'FontSize', 13);              %% -- CHANGE HERE
xlabel('X Value');
ylabel('Y Value');
hold on;
...
figure('NumberTitle','off');
cieplot();
title('Question 19: Male Users', 'FontSize', 13);              %% -- CHANGE HERE
xlabel('X Value');
ylabel('Y Value');
hold on;
...
figure('NumberTitle','off');
cieplot();
title('Question 19: Other Gender Users', 'FontSize', 13);              %% -- CHANGE HERE
xlabel('X Value');
ylabel('Y Value');
hold on;
...
writetable(onlineResults, '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19/q19_online_regular.csv');   % Online Regular Users Results Digested
writetable(onlineResults_dalt, '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19/q19_online_dalt.csv'); % Online Daltonic Users Results Digested
writetable(onlineResults_uncal, '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19/q19_online_uncal.csv'); % Online Uncalibrated Users Results Digested

writetable(laboratoryResults, '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19/q19_lab_regular.csv');     % Laboratory Regular Users Results Digested
writetable(laboratoryResults_dalt, '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19/q19_lab_dalt.csv');   % Laboratory Daltonic Users Results Digested

if isempty(whiteAnswers) ~= 1
    writetable(whiteAnswers,  '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19/q19_whiteAnswers.csv')
end

writetable(demoResultsAge_20, '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19/q19_age_20.csv', 'WriteRowNames', true);
writetable(demoResultsAge_20_29, '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19/q19_age_20_29.csv', 'WriteRowNames', true);
writetable(demoResultsAge_30_39, '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19/q19_age_30_39.csv', 'WriteRowNames', true);
writetable(demoResultsAge_40_49, '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19/q19_age_40_49.csv', 'WriteRowNames', true);
writetable(demoResultsAge_50_59, '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19/q19_age_50_59.csv', 'WriteRowNames', true);
writetable(demoResultsAge_60, '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19/q19_age_60.csv', 'WriteRowNames', true);
writetable(demoResultsGender_Female, '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19/q19_femaleGender.csv', 'WriteRowNames', true);
writetable(demoResultsGender_Male, '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19/q19_maleGender.csv', 'WriteRowNames', true);
writetable(demoResultsGender_Other, '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19/q19_otherGender.csv', 'WriteRowNames', true);
...
writetable(demoResults, '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 19/q19_allDemoResults.csv', 'WriteRowNames', true);