...
demoResultsAge_50_59     = tableDEM_age50_59(tableDEM_age50_59.id_question == 25,:); demoResultsAge_50_59 = sortrows(demoResultsAge_50_59, 'id'); demoResultsAge_50_59.id_question = []; demoResultsAge_50_59.page_time = []; demoResultsAge_50_59.resets = [];
...
scatter(x_pre_models(1), y_pre_models(1), 50, 'diamond', 'black', 'Filled');
text(x_pre_models(1) + 0.02, y_pre_models(1), '\leftarrow HSV', 'FontSize', 12);
scatter(x_pre_models(2), y_pre_models(2), 50, 'diamond', 'black', 'Filled');
text(x_pre_models(2) + 0.01, y_pre_models(2), ' \leftarrow LCh', 'FontSize', 12);
scatter(x_pre_models(3), y_pre_models(3), 50, 'diamond', 'black', 'Filled');
text(x_pre_models(3) - 0.02, y_pre_models(3) + 0.03, 'CMYK', 'FontSize', 12);
scatter(x_pre_models(4), y_pre_models(4), 50, 'diamond', 'black', 'Filled');
text(x_pre_models(4) + 0.01, y_pre_models(4) - 0.02, 'RGB', 'FontSize', 12);
scatter(x_pre_models(5), y_pre_models(5), 50, 'diamond', 'black', 'Filled');
text(x_pre_models(5) - 0.02, y_pre_models(5) - 0.03, 'Lab', 'FontSize', 12);
...
writetable(demoResults, '/Users/PauloGarcia/Documents/MATLAB/Results/First Study/Question 25/q25_allDemoResults.csv', 'WriteRowNames', true);